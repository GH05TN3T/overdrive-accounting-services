...
import { ArrowUpRight, CalendarDays, CheckCircle2, Clock3, ExternalLink, FileText, FolderOpen, LayoutDashboard, LoaderCircle, LogOut, RefreshCw, Save, Search, Settings, Trash2, Users, Video, X } from 'lucide-react'
...
export default function AdminDashboard() {
  ...
  return <DashboardFrame session={session} onSignOut={async () => { await apiRequest('/api/admin/logout', { method: 'POST' }); window.location.reload() }}>
